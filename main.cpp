...

{
    ...
    pintUser = new int [SIZE_PINT]; // 0 = user bank ID number; 1 =  user choice selection; 2 = index bank ID number balance; 3 = try count for bank operation; 4 = init loop for availibilty checking
