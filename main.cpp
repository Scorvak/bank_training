...

{
    ...
    pintUser = new int [SIZE_PINT]; // 0 = user bank ID number; 1 =  user choice selection; 2 = user bank ID checking number; 3 = index bank ID number balance; 4 = try count for bank operation; 5 = int loop for availibilty checking
